...
<%
	...
	LocalizationHelper helper = LocalizationHelper.getInstance(
			langSelected, getServletContext());
...
<link href="images/template2/tabcontent.css" rel="stylesheet"
	type="text/css" />
		...
		$.ajax({
			...
			success : function(data) {
				...
				if (obj.status == 200) {
					...
					profileString += "<tr><td><b>First Name:</b></td><td>"
							+ fName + "</td></tr>";
					profileString += "<tr><td><b>Last Name:</b></td><td>"
							+ lName + "</td></tr>";
					profileString += "<tr><td><b>Age:</b></td><td>" + age
							+ "</td></tr>";
					profileString += "<tr><td><b>Email:</b></td><td>" + pemail
							+ "</td></tr>";
					profileString += "<tr><td><b>Gender:</b></td><td>" + gender
							+ "</td></tr>";
	...
	function sendData() {
		...
		$
				.ajax({
					...
					type : 'POST',
					url : '/DeviceSensorAnalytics/rest/feedback/' + pEmail
							+ '/' + data,
					success : function(data) {
						//alert(data);
						var obj = $.parseJSON(data);
	...
	<div id="wsb-canvas-template-page" class="wsb-canvas-page page"
		...
		<div class="container">
			...
			<div class="tabcontents">
				...
				<div id="view2">
					<div>
						<h3 align="center"><%=helper.getText("reportGeneration")%></h3>  
						<div align="center">
							<table>
								<tr>
						...
						<div align="center">
							...
							<button class="button" id="getD" value="getD"
								onclick="getReportData();"><%=helper.getText("Get Report")%></button>
				...
				<div id="view3">
					<div>
						...
						<div align="center">
							...
							<button class="button" id="Send" value="Send"
								onclick="sendData();"><%=helper.getText("send")%></button>
						</div>
					</div>
				</div>
			</div>
		...
		<br>
		<div class="d_footer">
			<span class="copyright">© 2014 Health Service. All Rights
				Reserved. | </span> <a href="AboutUS.jsp">About Us </a>
		</div>
		<br> <br>
